...
public class EditorActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    private void savePet() {
        ...
        if (petUri == null) {
            ...
            if (newUri == null) {
                ...
                Toast.makeText(this, getString(R.string.pet_saving_error),
            ...
            if (rowsAffected == 0) {
                ...
                Toast.makeText(this, getString(R.string.pet_updating_error),
                        Toast.LENGTH_SHORT).show();
            } else {
    ...
    private void deletePet(){
        int result= getContentResolver().delete(petUri, null, null);
        if (result == 0) {
            // If no rows were affected, then there was an error with the update.
    ...
    public Loader<Cursor> onCreateLoader(int id, @Nullable Bundle args) {
        return new CursorLoader(this, petUri, null,null,null,null);
    }
    ...
    public void onLoadFinished(@NonNull Loader<Cursor> loader, Cursor data) {
        ...
        if(data.moveToNext()){
            ...
            mWeightEditText.setText(String.valueOf(data.getInt(data.getColumnIndex(PetEntry.COLUMN_PET_WEIGHT))));
    ...
    public void onLoaderReset(@NonNull Loader<Cursor> loader) {
        ...
        mGenderSpinner.setSelection(PetEntry.GENDER_UNKNOWN); // Select "Unknown" gender
    }
}